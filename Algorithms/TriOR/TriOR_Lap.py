...
for eps in epsilon_list:
    ...
    for k in range(rounds):
        ...
        #get resut
        guss_tri_Lap = np.trace(np.linalg.matrix_power(hat_A_Lap, 3)) / 6

        print("TriOR_Lap:", guss_tri_Lap)
    ...
    print('\n')
    print('epsilon=',eps,':')
    print("TriOR_Lap:",[float(x) for x in list_Lap] ,', MSE:', MSE_Lap, '     MRE:', ReE_Lap)
    print('\n')
